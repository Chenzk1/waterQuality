...
def main():
    # 解析json格式的数据
    rec_json = {'method': 'inverseWaterQuality', 'params': 
    '{"filePath":"remoteTableFile/maozhouhe0311.csv","bandWavelengthPath":"bandWavelengthFile/custom_1000.txt","resultFilePrefix":"/retrievalResultFile/NHResultFile","profilePath":"C:/Users/Chenzk/Documents/Learning/waterQuality/waterQuality/Files/","index":"nh","method":"多元回归模型","others":{"rgbPath":"","waterLandPath":""}}'}
    rec_json = {'method': 'inverseWaterQuality', 'params': 
    '{"filePath":"remoteImageFile/maozhouhe0311.tif","bandWavelengthPath":"bandWavelengthFile/custom_1001.txt","resultFilePrefix":"/retrievalResultFile/NHResultFile","profilePath":"C:/Users/Chenzk/Documents/Learning/waterQuality/waterQuality/Files/","index":"nh","method":"多元回归模型","others":{"rgbPath":"","waterLandPath":""}}'}
    ...
    if rec_json['method'] == 'getRgbFile':
        ...
        rgb_path = getRgbFile(params["filePath"], params["bandWavelengthPath"],
                    params["segmentFile"], params["profilePath"])
    ...
    print("运行时间：", (endtime - starttime).seconds, "s")
...
from utils import getDataDf, inverseTss, inverseTn, inverseTp, inverseChla, inverseNh
